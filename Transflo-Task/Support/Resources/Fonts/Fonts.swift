...
internal enum FontFamily {
  ...
  internal enum SFProDisplay {
    ...
    internal static let heavyItalic = FontConvertible(name: "SFProDisplay-HeavyItalic", family: "SF Pro Display", path: "SF-Pro-Display-HeavyItalic.ttf")
    ...
    internal static let all: [FontConvertible] = [black, bold, heavy, heavyItalic, light, medium, regular, semibold, semiboldItalic, thin, ultralight]
  }
  internal static let allCustomFonts: [FontConvertible] = [Quicksand.all, SFProDisplay.all].flatMap { $0 }
